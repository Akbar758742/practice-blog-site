<div>
            ...
            <div class="card-box height-100-p pd-20">
                ...
                <ul class="list-group list-group-flush">
                    @if($postsWithoutCategory > 0)
                        <li
                            class="list-group-item d-flex justify-content-between align-items-center text-danger px-0 py-1 border-0">
                    ...
                    @if($postsWithoutImage > 0)
                        <li
                            class="list-group-item d-flex justify-content-between align-items-center text-warning px-0 py-1 border-0">
                    ...
                    @if($oldDrafts > 0)
                        <li
                            class="list-group-item d-flex justify-content-between align-items-center text-secondary px-0 py-1 border-0">
                    ...
                    @if($postsNeedingUpdate > 0)
                        <li
                            class="list-group-item d-flex justify-content-between align-items-center text-info px-0 py-1 border-0">
    ...
    <div class="row pb-10">
        <div class="col-md-8 mb-20">
            ...
            <div class="card-box pd-20 mb-20 border-left-4 border-indigo-500"
                style="background: repeating-linear-gradient(45deg,#f9f9f9,#f9f9f9 10px,#ffffff 10px,#ffffff 20px);">
                <div class="d-flex align-items-center justify-content-between">
                    <div>
                        <div class="h5 mb-1">Traffic Analytics</div>
                        <div class="font-14 text-secondary">Detailed insights coming soon via Google Analytics 4
                            integration.</div>
                    </div>
            ...
            <div class="card-box height-100-p pd-20">
                <div class="d-flex flex-wrap justify-content-between align-items-center pb-0 pb-md-3">
                    ...
                    <div class="btn-group btn-group-sm">
                        <button type="button"
                            class="btn {{ $activeFilter === 'latest' ? 'btn-primary' : 'btn-outline-primary' }}"
                            wire:click="setFilter('latest')">Latest</button>
                        <button type="button"
                            class="btn {{ $activeFilter === 'published' ? 'btn-success' : 'btn-outline-success' }}"
                            wire:click="setFilter('published')">Published</button>
                        <button type="button"
                            class="btn {{ $activeFilter === 'drafts' ? 'btn-warning' : 'btn-outline-warning' }}"
                            wire:click="setFilter('drafts')">Drafts</button>
                        <button type="button"
                            class="btn {{ $activeFilter === 'scheduled' ? 'btn-info' : 'btn-outline-info' }}"
                            wire:click="setFilter('scheduled')">Scheduled</button>
                    </div>
                </div>
                <div class="user-list">
                    <ul>
                            ...
                            <li class="d-flex align-items-center justify-content-between">
                                <div class="name-avatar d-flex align-items-center pr-2">
                                    <div class="avatar mr-2 flex-shrink-0">
                                        ...
                                        @else
                                            <div
                                                class="width-50 height-50 bg-gray-200 border-radius-100 d-flex align-items-center justify-content-center text-gray-500">
                                    ...
                                    <div class="txt">
                                        ...
                                        <div class="font-12 weight-500" data-color="#b2b1b6">
                                            ...
                                            @elseif($post->status === \App\Enums\PostStatus::Pending)
                                                <span class="text-info ml-1">• Pending</span>
                                            @else
                                                <span class="text-secondary ml-1">• Archived</span>
                                            @endif
                                        </div>
                                    </div>
                                </div>
